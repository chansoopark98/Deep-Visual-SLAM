...
# python code/python/tools/dataset_download_images.py --downloads_dir /media/park-ubuntu/park_file/hypersim_raw --decompress_dir /media/park-ubuntu/park_file/hypersim
