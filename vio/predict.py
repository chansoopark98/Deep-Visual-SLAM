...
if __name__ == '__main__':
    ...
    depth_net.load_weights('./weights/imu_test_dataV2_poseNet/depth_net_epoch_15_model.h5')
    ...
    pose_net.load_weights('./weights/imu_test_dataV2_poseNet/pose_net_epoch_15_model.h5')
    ...
    for idx, (ref_images, target_image, imus, intrinsics) in enumerate(valid_tqdm):
        ...
        # # 렌더링용 카메라 업데이트
        # plotter.camera.position = render_camera_position
        # plotter.camera.focal_point = cam_center
        # plotter.camera.up = cam_up  # 카메라의 위쪽 방향 설정
