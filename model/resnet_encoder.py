...
def resnet_multiimage_input(num_layers, pretrained=False, num_input_images=1):
    ...
    if pretrained:
        # 먼저 일반 ResNet 모델을 생성하여 pretrained weights를 로드
        if num_layers == 18:
        ...
        # pretrained model의 state_dict를 가져옴
        loaded = pretrained_model.state_dict()
        
        # conv1의 weight를 수정하여 multiple input images를 처리할 수 있도록 함
...
if __name__ == "__main__":
    ...
    dummy_input = torch.randn(1, 6, 224, 224)  # Batch size of 1, 2 images stacked
